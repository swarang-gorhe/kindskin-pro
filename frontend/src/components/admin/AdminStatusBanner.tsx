...
export function AdminStatusBanner({
  ...
  return (
    <div className="mb-6 flex items-start gap-3 rounded-xl border border-sage/25 bg-sage/8 px-4 py-3.5 text-[13px] text-forest shadow-soft">
      ...
      <div className="flex-1 leading-relaxed text-muted">
        {message ?? (
          <>
            ...
            <code className="rounded-md bg-cream-dark px-1.5 py-0.5 text-[11px] font-mono text-forest">
      ...
      <button
        ...
        className="shrink-0 flex h-7 w-7 items-center justify-center rounded-full text-muted hover:bg-cream-dark hover:text-forest transition-colors"
        aria-label="Dismiss"
      >
        <X size={14} />
      </button>
